...
if (_commander2.default.input) {
  ...
  if (svgPath.ext === '.svg') {
    ...
    var outputFilename = outputParsedPath.name;
    if (!outputPath) {
    ...
    (0, _mkdirp2.default)(_path2.default.dirname(parsedSVGPath), function (error) {
      ...
      renderTemplate(svgData, (0, _uppercamelcase2.default)(outputFilename));
    });
  } else {
...
function renderProps(attributes, level) {
  ...
  keys.forEach(function (key) {
    if (key !== 'transform') props += (0, _camelcase2.default)(key) + '="' + processPropValue(attributes[key]) + '"\n';else {
